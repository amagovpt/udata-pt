...
def new_membership_request(org: Organization, request: MembershipRequest) -> MailMessage:
    return MailMessage(
        ...
        paragraphs=[
            ...
            MailCTA(_("See the request"), cdata_url(f"/admin/org/{org.id}/members")),
        ],
    )
...
def membership_accepted(org: Organization) -> MailMessage:
    return MailMessage(
        ...
        paragraphs=[
            ...
            MailCTA(_("View the organization"), cdata_url(f"/admin/org/{org.id}/datasets")),
        ],
    )
...
def membership_invitation_accepted(org: Organization, invitation: MembershipRequest) -> MailMessage:
    return MailMessage(
        ...
        paragraphs=[
            ...
            MailCTA(_("View the organization"), cdata_url(f"/admin/org/{org.id}/members")),
        ],
    )
